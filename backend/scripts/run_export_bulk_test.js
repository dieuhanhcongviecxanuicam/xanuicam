...
(async ()=>{
  try{
    ...
    const res = await axios.post(`${API_BASE}/audit-logs/export`, { format: outFormat, page: 1, limit: 100 }, { headers: { Authorization: `Bearer ${token}`, Accept: '*/*' }, responseType: 'arraybuffer' });
