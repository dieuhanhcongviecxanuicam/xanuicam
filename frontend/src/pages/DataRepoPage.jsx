// ubndxanuicam/frontend/src/pages/DataRepoPage.jsx
// Derived from HandbookPage - renamed to reflect "Kho dữ liệu số"
...
const DataRepoPage = () => {
    ...
    const fetchArticles = useCallback(async () => {
        ...
        try {
            ...
            setNotification({ message: 'Không thể tải dữ liệu kho dữ liệu số.', type: 'error' });
        } finally {
            setLoading(false);
        }
    }, []);
    ...
    const goToDeletedArticles = () => navigate('/data-repo/deleted');
    const goToDeletedAttachments = () => navigate('/data-repo/deleted-attachments');
            ...
            <div>
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                    <div className="flex items-center">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-slate-800">Kho dữ liệu số</h1>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {canManageArticles && (
                            <div className="flex gap-2">
                                <button className="btn" onClick={goToDeletedAttachments}>Tệp đã xóa</button>
                                <button className="btn" onClick={goToDeletedArticles}>Bài viết đã xóa</button>
                            </div>
                        )}
                    </div>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow-lg">
                    {loading ? (
                        ...
                        <p className="text-center py-20 text-slate-500">Chưa có bài viết nào trong Kho dữ liệu số.</p>
                    )}
                </div>
            </div>
        </>
