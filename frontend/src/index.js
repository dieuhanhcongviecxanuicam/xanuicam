...
import './index.css';
import App from './App';
// Initialize Sentry early if configured (REACT_APP_SENTRY_DSN)
// Use the safe initializer which avoids top-level await syntax that can
// trigger parser errors in some CI lint/build environments.
import './sentryInit_safe';
